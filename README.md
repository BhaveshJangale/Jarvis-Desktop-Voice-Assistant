...
4. **Install Requirements**
   ...
   - Install all the requirements given in **[requirements.txt](https://github.com/BhavesJangale/Jarvis-Desktop-Voice-Assistant/blob/main/requirements.txt)** by running the command `pip install -r requirements.txt`
